...
Clearly, our values are too high, only somehow within range. This can have a bunch of reasons, among these a too coarse mesh (only ~1.5M cells) and/or a to small simulation volume and also not fully developed flow. 
